...
/**
	...
	CHECKPOINT:
		* The two modifications above allowed to decrease the SDC rate from 
		  12% to 5% adding 25% of overhead
		* Main SDC causes that persisted:
			Injected 11407 faults -> 612 SDCs
			- var pos - line 101 - 83.3% SDCs -> 80 SDCs
			- vectors x, y and T - 16.2%, 11.3% and 13.2% SDCs -> 81, 60, 69 SDCs
			- var pD - line 102 - 36% SDCs -> 40SDCs
			- var iterations - line 141 - 28% SDC -> 36 SDCs
			- var predictions - line 203 - 35% SDC -> 33 SDCs
		* New Solutions:
			
			- triplicate pos, iterations and predictions
*/
